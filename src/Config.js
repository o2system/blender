...
module.exports = function() {
    return {
        ...
        /**
         * Determine if Blender should remove unused selectors from your CSS bundle.
        ...
        babel: function(babelRcPath) {
            babelRcPath = babelRcPath || Blender.paths.root('.babelrc');
        ...
        /**
         * Custom Webpack-specific configuration to merge/override Blender's.
         *
         * @type {Object}
         */
        webpackConfig: {},
        ...
        /**
         * Custom Babel configuration to be merged with Blender's defaults.
         *
         * @type {Object}
         */
        babelConfig: {},
        ...
        /**
         * Determine if Blender should ask the friendly errors plugin to
